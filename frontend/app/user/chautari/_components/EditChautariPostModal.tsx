...
export default function EditChautariPostModal({
  isOpen,
  isSaving,
  initialCaption,
  onClose,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl dark:border-zinc-800 dark:bg-zinc-900">
        <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">Edit Post</h3>
        <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
          Update your post caption or replace media.
        </p>
        ...
        <div className="mt-4 space-y-3">
          ...
          >
            <ImagePlus size={14} />
            {file ? file.name : "Replace media (optional)"}
            <input
              type="file"
              accept="image/*,video/*"
              className="hidden"
